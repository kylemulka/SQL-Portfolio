...
SELECT film_cat.category_id, 
	...
	ROUND(AVG(film.replacement_cost), 2) AS avg_replacement_cost,
	ROUND(overall_avg.total_avg_replacement_cost, 2) AS total_avg_replacement_cost,
	ROUND(AVG(film.replacement_cost) - (overall_avg.total_avg_replacement_cost), 2) AS replacement_cost_diff
